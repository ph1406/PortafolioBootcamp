...
public class UsuarioDAO {
    ...
    @OneToMany(mappedBy = "idPortafolio")
    private List<PortafolioDAO> portafolios;
    ...
    public List<PortafolioDAO> getPortafolios() {
        return portafolios;
    }

    public void setPortafolios(List<PortafolioDAO> portafolios) {
